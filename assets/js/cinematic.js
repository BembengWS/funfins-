const products = [
  ...
  {name:'FUNFINS+ Twin-Notch Blade Only',description:'Smooth & balance. Controlled movement, stable response and distinctive twin-notch geometry.',type:'TWIN-NOTCH',image:'products/type-4/funfins-type4-red-ferrari.jpg',href:'products/type-4/',price:'FROM RP 1.000.000'},
  {name:'FUNFINS+ Crown Blade Only',description:'Stability & control. Stable movement, balanced response and a distinctive crown profile.',type:'CROWN',image:'products/type-5/funfins-type5-red-ferrari.jpg',href:'products/type-5/',price:'FROM RP 1.000.000'},
  {name:'FUNFINS+ Arrow Blade Only',description:'Precision & control. Clean directional movement, progressive response and a distinctive V-notch profile.',type:'ARROW',image:'products/type-6/funfins-type6-red-ferrari.jpg',href:'products/type-6/',price:'FROM RP 1.000.000'},
  {name:'FUNFINS+ Contour Blade Only',description:'Flow & control. Smooth movement, progressive flex and a balanced central contour.',type:'CONTOUR',image:'products/type-7/funfins-type7-red-ferrari.jpg',href:'products/type-7/',price:'FROM RP 1.000.000'}
];
