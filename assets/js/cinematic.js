const products = [
  ...
  {name:'FUNFINS+ Crescent / Twin-Notch Blade Only',description:'Smooth & balance. Controlled movement, stable response and distinctive twin-notch geometry.',type:'CRESCENT / TWIN-NOTCH',image:'products/type-4/funfins-type4-red-ferrari.jpg',href:'products/type-4/',price:'FROM RP 1.000.000'},
  {name:'FUNFINS+ Wave-S Blade Only',description:'Stability & control. Stable movement, balanced response and a distinctive Wave-S profile.',type:'WAVE-S',image:'products/type-5/funfins-type5-red-ferrari.jpg',href:'products/type-5/',price:'FROM RP 1.000.000'},
  {name:'FUNFINS+ V-Cut Blade Only',description:'Precision & control. Clean directional movement, progressive response and a distinctive V-cut profile.',type:'V-CUT',image:'products/type-6/funfins-type6-red-ferrari.jpg',href:'products/type-6/',price:'FROM RP 1.000.000'},
  {name:'FUNFINS+ Wing / Up-Sweep Blade Only',description:'Flow & control. Smooth movement, progressive flex and a balanced wing / up-sweep geometry.',type:'WING / UP-SWEEP',image:'products/type-7/funfins-type7-red-ferrari.jpg',href:'products/type-7/',price:'FROM RP 1.000.000'}
];
