const product={
  name:"FUNFINS+ Type 1 Blade Only",
  image:"funfins-type1-red-ferrari.jpg",
  colors:[
    {name:"Red Ferrari",image:"funfins-type1-red-ferrari.jpg"},
    {name:"Black",image:"funfins-type1-black.jpg"},
    {name:"Ocean Blue",image:"funfins-type1-ocean-blue.jpg"},
    {name:"Forest Green",image:"funfins-type1-forest-green.jpg"},
    {name:"Pearl White",image:"funfins-type1-pearl-white.jpg"},
    {name:"Sun Yellow",image:"funfins-type1-sun-yellow.jpg"}
  ],
  rails:{
    "Water Rails":1500000,
    "U-List":1000000
...
let selected={
  ...
  stiffness:"Medium",
  color:"Red Ferrari",
  colorImage:"funfins-type1-red-ferrari.jpg",
  qty:1
};
  ...
  button.addEventListener("click",()=>{
    ...
    if(image){
      ...
      setTimeout(()=>{
        ...
        image.alt="FUNFINS+ Type 1 Blade Only — "+selected.color;
