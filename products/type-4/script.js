const product={
  name:"FUNFINS+ Twin-Notch Blade Only",
  image:"funfins-type4-red-ferrari.jpg",
  colors:[
    {name:"Red Ferrari",image:"funfins-type4-red-ferrari.jpg"},
    {name:"Black",image:"funfins-type4-black.jpg"},
    {name:"Ocean Blue",image:"funfins-type4-ocean-blue.jpg"},
    {name:"Pearl White",image:"funfins-type4-pearl-white.jpg"},
    {name:"Sun Yellow",image:"funfins-type4-sun-yellow.jpg"},
    {name:"Pink",image:"funfins-type4-pink.jpg"}
  ],
  rails:{
    "Water Rails":1500000,
    "U-List":1000000
...
let selected={
  ...
  stiffness:"Medium",
  color:"Red Ferrari",
  colorImage:"funfins-type4-red-ferrari.jpg",
  qty:1
};
  ...
  button.addEventListener("click",()=>{
    ...
    if(image){
      ...
      setTimeout(()=>{
        ...
        image.alt="FUNFINS+ Twin-Notch Blade Only — "+selected.color;
        image.style.opacity="1";
      },120);
    }
    if(summaryImage){
      summaryImage.src=selected.colorImage;
      summaryImage.alt="FUNFINS+ Twin-Notch Blade Only — "+selected.color;
    }
