const product={
  name:"FUNFINS+ Type 3 Blade Only",
  image:"funfins-type3-red-ferrari.jpg",
  colors:[
    {name:"Red Ferrari",image:"funfins-type3-red-ferrari.jpg"},
    {name:"Black",image:"funfins-type3-black.jpg"},
    {name:"Ocean Blue",image:"funfins-type3-ocean-blue.jpg"},
    {name:"Forest Green",image:"funfins-type3-forest-green.jpg"},
    {name:"Pearl White",image:"funfins-type3-pearl-white.jpg"},
    {name:"Sun Yellow",image:"funfins-type3-sun-yellow.jpg"}
  ],
  rails:{
    "Water Rails":1500000,
    "U-List":1000000
  ...
  button.addEventListener("click",()=>{
    ...
    if(image){
      ...
      setTimeout(()=>{
        ...
        image.alt="FUNFINS+ Type 3 Blade Only — "+selected.color;
        image.style.opacity="1";
      },120);
    }
    if(summaryImage){
      summaryImage.src=selected.colorImage;
      summaryImage.alt="FUNFINS+ Type 3 Blade Only — "+selected.color;
    }
